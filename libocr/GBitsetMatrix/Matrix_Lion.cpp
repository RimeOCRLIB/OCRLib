...
/**/
	...
	int sx0,sy0,sx1,sy1;
	int x=0,y=0,m=0,n=0,t=0;                 //  ,p,d
	int LfAmSum=0,RgAmSum=0;
	int Lf=0,Rg=0,LfMem=0,RgMem=0, Delta=0;  //float Lf,Rg,LfMem,RgMem, Delta;
    int LfxP=0, RgxP=0, LfyP=0, RgyP=0;
...
/**/
	...
	int X,Y,X0,X1,Y0,Y1,Cor,maxCor,AdrCorX=0,AdrCorY=0;
