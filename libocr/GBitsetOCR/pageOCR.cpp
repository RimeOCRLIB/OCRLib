...
TIME_START
    ...
    vector<OCRPointFloat>focalPoint;        //массив фокальных точек
    vector<OCRFocalLineBezier>focalLine;     //массив фокальных линий
    ...
    GGraphBezier pechaGraph=GGraphBezier(pechaImg);
