...
void GLogicProcessor::letterNeighborsSanskrit(vector<OCRMatch>&matchLine,GBitmap* lineImg32,GBitmap* letterAImg,GBitmap* letterBImg){
    ...
    for(int i=0;i<matchLine.size();i++){ //if(step>1000){DR(", "<<i; step=0;}step++;
        ...
        //print=0; if(i==168)print=1;   if(!print)continue;
        ...
        for(int j=0;j<matchLine.size();j++){
            ...
            //print=0; if(j==168){print=1;}else{continue;}
