...
void GLogicProcessor::letterProbability(vector<OCRMatch>&matchLine){
    ...
    while(1){
        ...
        for(int i=0;i<cLine.size();i++){
            ...
            int x0__=0; if(x0>x0_)x0__=x0; if(x0<=x0_)x0__=x0_;
            int x1__=0; if(x1<x1_)x1__=x1; if(x1>=x1_)x1__=x1_;
            
            int y0__=0; if(y0>y0_)y0__=y0; if(y0<=y0_)y0__=y0_;
            int y1__=0; if(y1<y1_)y1__=y1; if(y1>=y1_)y1__=y1_;
