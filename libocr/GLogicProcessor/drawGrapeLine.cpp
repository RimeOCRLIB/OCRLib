...
void GLogicProcessor::drawGrapeLine(vector<OCRMatch>&line){
 ...
 while(1){
     ...
     //cout<<" maxC="<<maxC<<" n="<<dLine[maxIndex].name<<" letterID:"<<dLine[maxIndex].letterID<<" grapeLine.size()="<<grapeLine.size()<<" rowCount="<<rowCount<<endl;
