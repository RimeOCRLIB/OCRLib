...
#include <time.h>
#include <math.h>
#include <complex> // Комплексные числа. Быстрое преобразование Фурье. OCRAlgorithmFFT.cpp
...
/** @bref вычисление параметров кубической апроксимации Безъе */
void curveQubicAproximation(OCRPoint &p0, OCRPoint &p1, OCRPoint &p2, OCRPoint &p3);
/** @bref вычисление параметров квадратичной апроксимации Безъе */
