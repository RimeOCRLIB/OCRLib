...
GBitset::GBitset(GBitmap *ref, short stepW, short stepH, short flipV)
  : nrows(0), ncolumns(0), border(0),
	bits_per_row(0),data_size(0)
{
  try
...
GBitset::GBitset(GBitmap *ref, GBitmap *ref1)
  : nrows(0), ncolumns(0), border(0),
	bits_per_row(0),data_size(0)
{
  try
...
GBitset::GBitset(GBitset *ref, int border)
  : nrows(0), ncolumns(0), border(0),
	bits_per_row(0),data_size(0)
{
  try
...
void
GBitset::init(GBitset *ref, int aborder)
{
