...
///TIME_START      
    ...
    uint SPhraseHits=0;          // суммарная длина всех совпавших фраз словаря с фразами распознаваемого текста
...
int j=0;/////////////
    ...
    for( n=0; n < nEnter; n++ ) {  //cout<<n<<" ";  
        ...
        //cout<<w<<"  "<<oldw<<endl;
        if ( w-oldw > 1500  ) {
            cout<<n<<"слишком длиная фраза словаря ERROR "<<w-oldw;exit(0);
        }
...
//    cout<<"найдено фраз "<<resultReport.size()<<endl;
    ...
    cout<<"суммарная длина всех совпавших фраз словаря с фразами текста SPhraseHits="<<SPhraseHits<<endl;
