...
void GMap::processKeyWordlist(string &key,ulong index, uint field){
    string tab="\t";
    ...
    //#442((GLogicProcessor *)inputData.logicProcessor)->encodeByID(key);
