...
//#include <math.h>
namespace ocr{
void adaptiveFiltration1(GBitmap *img_pecha,float *p,int mode){
    //int line_width=44;
    int  line_wd1=0;// line_wd2=0, line_wd0=0,
    //int line_wd;
...
void adaptiveFiltration(GBitmap *img_pecha,float scale,int mode){
  
  
    int GrafT=0; //вывод отладочной информации
