...
namespace ocr{
    ...
    float GGraph::CorrelationBezierPart(OCRFocalLine &line1, OCRFocalLine &line2, OCRFocalLine &line3){
        ...
        // Линия N3 сейчас сохраняется в линии N2 (OCRFocalLine &line3 не используется).
        ...
        // (подсчитаны в GGraphFocalLineRecBezier.cpp) //
      ...
      /**/
        ...
        /*
         ...
         OCRPoint *mTab=(OCRPoint*)&line2.mTab[0];    // получаем указатель mTab.
  ...
  /*
    ...
    // Функция для сравнения (корреляции) одной кривой Безье с частью другой кривой Безье.
    float GGraph::CorrelationBezier1(OCRFocalLine &line1, OCRFocalLine &line2, OCRFocalLine &line3){
        ...
        OCRPoint *mData2=(OCRPoint*)&line2.mData[0];
