...
namespace ocr{
    ...
    void GGraph::Test(OCRFocalLine &line1, OCRFocalLine &line2){
        ...
        // 1) перебрать все линии (как в GGraphFocalLineRecognition точки) и составить цепочки из кривых которые стыкуются.
