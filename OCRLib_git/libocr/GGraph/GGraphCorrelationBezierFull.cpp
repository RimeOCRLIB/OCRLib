...
namespace ocr{
    ...
    float GGraph::CorrelationBezierT(OCRFocalLine &line1, OCRFocalLine &line2){
        ...
        */
        ...
        float L1x0=line1.p0_с.x;            float L1y0=line1.p0_с.y;    // приведенные координаты точки p0 линии L1    start_с
        ...
        float L2x0=line2.p0_с.x;            float L2y0=line2.p0_с.y;    // приведенные координаты точки p0 линии L2    start_с
        ...
        //if(GrafT)cout<<"line1.p0_с.x="<<line1.p0_с.x<<"   line2.p0_с.x="<<line2.p0_с.x<<endl;
    ...
    float GGraph::CorrelationBezierA(OCRFocalLine &line1, OCRFocalLine &line2, int pCor){
...
///            register1++;
    ...
    float GGraph::CorrelationBezierB(OCRFocalLine &line1, OCRFocalLine &line2, int mirror, int ln, int p1, int p1p2, int p2){
