...
namespace pugi
{
	...
	public:
		 ...
		 */
		void print_(xml_writer& writer, const char* indent = "\t", unsigned int flags = format_default, unsigned int depth = 0);
		 ...
		 */
		void print_(std::ostream& os, const char* indent = "\t", unsigned int flags = format_default, unsigned int depth = 0);
	#endif
