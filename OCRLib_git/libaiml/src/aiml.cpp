...
/** core options **/
cCoreOptions::cCoreOptions(void) : file_gossip(inputData.data["rootAIML"]+"gossip.txt"), user_file(inputData.data["rootAIML"]+"/userlist.xml"), sentence_limit("?!.;"),
