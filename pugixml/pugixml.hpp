...
namespace pugi
{
	...
	public:
		 ...
		 */
		void print_xml(xml_writer& writer, const char* indent = "\t", unsigned int flags = format_default, unsigned int depth = 0);
		 ...
		 */
		void print_xml(std::ostream& os, const char* indent = "\t", unsigned int flags = format_default, unsigned int depth = 0);
	#endif
