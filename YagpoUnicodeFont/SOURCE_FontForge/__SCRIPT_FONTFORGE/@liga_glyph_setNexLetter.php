...
function setNextLetter($name,$baseGlyph,$next,$uniArray,$i,$l){
	...
	if($b=="yatag"||$b=="lce_tsa_can"||$b=="gter_yig"||$b=="mchu_can"||$b=="gru_can_rgyings"||$b=="gru_med_rgyings"){
		$baseGlyph=$b;
	}
	...
	if($n[0]=="_"&&$n[1]!="u"){
		$anchorBase="Anchor-0";
		$anchorNext="Anchor-0";
		if($n=="_i"||$n=="_iM"||$n=="_iMM"||$n=="__i"||$n=="__iM"||$n=="_e"||$n=="_ai"||$n=="_aiM"||$n=="_aiMM"){
			$anchorBase="Anchor-7";
			$anchorNext="Anchor-7";
	...
	if($n=="yatag"){
		$anchorBase="Anchor-2";
		$anchorNext="Anchor-0";
		if($b=="ca"||$b=="cha"||$b=="tsa"||$b=="tsha"){
			$anchorBase="Anchor-3";
			$anchorNext="Anchor-3";
		}
		if($b=="ratag"||$b=="ratag1"||$b=="g.ra"||$b=="k.ra"||$b=="kh.ra"){
			$n="yatag2";
			$anchorBase="Anchor-2";
			$anchorNext="Anchor-0";
		}
		if($b=="d.ra"||$b=="dz.ra"||$b=="n.ra"||$b=="ng.ra"||$b=="achung.ra"||$b=="h.ra"||$b=="t.ra"||$b=="ny.ra"){
			$n="yatag2";
			$anchorBase="Anchor-5";
			$anchorNext="Anchor-3";
		}
	...
	if($n=="_u"){
		...
		$anchorNext="Anchor-0";
		$next="_u";
		if($b=="yatag"||$b=="yatag2"||$b=="k.ya"||$b=="kh.ya"||$b=="g.ya"||$b=="ny.ya"||$b=="h.ya"||$b=="t.ya"||$b=="T.ya"||$b=="n.ya"||$b=="d.ya"
			||$b=="D.ya"||$b=="sh.ya"||$b=="Sh.ya"||$b=="Th.ya"||$b=="ca"||$b=="cha"||$b=="tsa"||$b=="tsha"){
			$anchorBase="Anchor-4";
			$next="_u5";
		}
	...
	if($b=="la"||$b=="ma"||$b=="sa"||$b=="ya"||$b=="Ya"||$b=="pa"||$b=="pha"||$b=="ba"||$b=="wa"||$b=="aa"||$b=="za"||
		...
		$n=="ng.ra"||$n=="T.ra"||$n=="N.ra"||$n=="D.ra"||$n=="Sh.ra"||$n=="rtsa"||$n=="rdsa"||$n=="r.dz.ra"||$n=="r.dz.ya"){
			...
			if($n[0]!="_"&&$n!="ratag"&&$n!="ratag1"&&$n!="ratag_"&&$n!="ratag_1"&&$n!="yatag"&&$n!="yatag2"&&$n!="vasur"&&$n!="halanta"){
				$anchorBase="Anchor-6";
				$anchorNext="Anchor-9";	
			}
		}
