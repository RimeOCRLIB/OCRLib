...
//print "@@@3=".$argv[1]."\n";
$path_list="/Volumes/WORK_DHARMA_3TB/SAMSUNG/MainYagpoOCR/Font/__SCRIPT_FONTFORGE/_namelist.txt";
	...
	$ligaTextMain="";
				...
				for($index=100;$index>=0;$index--){
					if(count($ligaSort[$index])!=0){
						...
						$table=$index;
						$lookup=1;
						$ligaTextMain.="AddLookupSubtable(\"tibetanLigatures".$lookup."\",\"ligaData".$table."\");\n"; 	
						...
						for($i=0;$i<count($liga);$i++){		    		
							...
							$l=str_replace(":|:","",$l);
							$line=explode("\t",$l);     	
							$ligaTextMain.="Select(\"".$line[1]."\"); AddPosSub(\"ligaData".$table."\", \"";
							$data="";
			...
			writeText($ligaTextMain,$path_list_name."_uni.pe");
